...
(fn _)"]
 ...
 '(package-selected-packages
   (quote
    (dante zoom-window yasnippet yaml-mode which-key vlf use-package suggest smex smartparens scala-mode nyan-mode multiple-cursors monokai-theme lsp-ui lsp-scala lsp-haskell lcr key-chord idris-mode hydra helm-swoop helm-projectile helm-lsp helm-etags-plus helm-ag git-timemachine git-gutter flycheck-haskell evil-surround evil-mc evil-magit evil-leader eno elmacro dockerfile-mode csv-mode company-lsp ag ace-window)))
